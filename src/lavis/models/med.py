...
from lavis.transformers_v4p34_local import BatchEncoding, PreTrainedTokenizer

from lavis.transformers_v4p34_local.activations import ACT2FN
from lavis.transformers_v4p34_local.file_utils import (
    ModelOutput,
)
from lavis.transformers_v4p34_local.modeling_outputs import (
...
from lavis.transformers_v4p34_local.modeling_utils import (
    PreTrainedModel,
    apply_chunking_to_forward,
    find_pruneable_heads_and_indices,
    prune_linear_layer,
)
from lavis.transformers_v4p34_local.utils import logging
from lavis.transformers_v4p34_local.models.bert.configuration_bert import BertConfig
